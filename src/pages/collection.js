...
return (
  ...
  <GlobalStyles/>
      ...
      <section id='profile_banner' className='jumbotron breadcumb no-bg' style={{backgroundImage:'./img/author_single/author_thumbnail.jpg'}}>
                ...
                <div className="profile_name">
                  <h4>
                      ...
                      <div className="clearfix"></div>
                        <span id="wallet" className="profile_wallet">0x1234</span>
    ...
    <section className='container no-top'>
        ...
        {openMenu && (  
          <div id='zero1' className='onStep fadeIn'>
            <ColumnNewRedux shuffle showLoadMore={false} authorId={dummyData.author } />
          </div>
        )}
        {openMenu1 && ( 
